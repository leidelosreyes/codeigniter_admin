...
function b_edit(id, item, value, title){
    clear_form();
    $("#crud_form").show();
    $("#crud_label").html("Edit Gbh758 "+id);
    $("#action_type").val(id);
                ...
                action: function(){
                    ...
                    function(data, status){
                        if(data.status == 0)
                        {
                            ...
                            $('#gbh758_datatable').DataTable().ajax.reload();
